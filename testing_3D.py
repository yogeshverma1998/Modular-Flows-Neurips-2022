...
saved_models = ['/data/pre_trained_model/ZINC_3D_pretrained.pt','']
...
for i in Smiles[0:args.esamples]:
    ...
    data = get_graph_data_with_polar_3D_eval(i,Unique_elements,conf,rdkit_mol)
...
for trial in range(args.n_trials):
    ...
    for idx,k in enumerate(eval_loader):   
                ...
                gen_smiles,score = check_validity_ZINC(data,z[100],Unique_elements,num,0,k[1])
                if score == 1: 
    ...
    validity_ratio.append(valid/len(eval_data))
